export const projects = [
  ...
  },
  {
    ...
    category: "Baños",
    images: [
      "/productos/banos/BAÑOS (1).jpeg",
      "/productos/banos/BAÑOS (2).jpeg",
      "/productos/banos/BAÑOS (3).jpeg",
      "/productos/banos/BAÑOS (4).jpeg",
      "/productos/banos/BAÑOS (5).jpeg"
    ],
    description: "Renovación completa de baños con materiales resistentes a la humedad, diseños contemporáneos y optimización del espacio para mayor confort."
  },
  {
    id: 3,
    title: "Mobiliario Escolar - Aula Interactiva",
    category: "Escolar",
    images: [
      "/productos/aulas/AULA (1).jpeg",
      "/productos/aulas/AULA (2).jpeg",
      "/productos/aulas/AULA (3).jpeg",
...
export const furniture = [
  {
    id: 1,
    title: "Camas de Diseño y Modernas",
    category: "Camas",
    images: [
